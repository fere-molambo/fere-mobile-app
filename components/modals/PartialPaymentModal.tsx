...
export default function PartialPaymentModal({ visible, onClose, onConfirm }: Props) {
      ...
      <View style={styles.overlay}>
        <View style={styles.sheet}>
          <View style={styles.sheetHeader}>
            <Text style={styles.sheetTitle}>Paiement partiel (50%)</Text>
          ...
          <View style={styles.warningBox}>
            ...
            <Text style={styles.warningText}>
              Vous allez payer 50% du montant de la prestation. Veuillez selectionner un motif d'insatisfaction et fournir une preuve.
            </Text>
          </View>
          ...
          <ScrollView style={styles.sheetContent} showsVerticalScrollIndicator={false}>
            {loadingReasons ? (
              ...
              <>
                <Text style={styles.label}>Motif d'insatisfaction</Text>
                {reasons.map((reason) => (
                  <TouchableOpacity
                    key={reason.id}
                    style={[
                ...
                <Text style={[styles.label, { marginTop: 16 }]}>Preuve (photo ou fichier)</Text>
          ...
          <View style={styles.sheetFooter}>
            ...
            >
              {loading ? (
                ...
                <Text style={styles.confirmBtnText}>Payer 50%</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
