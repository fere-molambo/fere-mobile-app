...
export const PREFERENCE_LABELS: Record<string, { label: string; description: string }> = {
  ...
  booking_reminders: { label: 'Rappels reservation', description: 'Rappels avant vos reservations' },
  ...
  new_bookings: { label: 'Nouvelles reservations', description: 'Alertes pour chaque nouvelle reservation' },
